...
const AdminLogin = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    // const res = await fetch("http://localhost/karmashila/Auth/AdminLogin.php", {
    const res = await fetch("https://karmasila.com.np/karmashila/Auth/AdminLogin.php", {
      method: "POST",
  ...
  <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-black p-4">
    ...
    />
      ...
      <button
        type="submit"
        className="w-full bg-yellow-500 text-black py-2 rounded hover:bg-yellow-600 disabled:opacity-50"
        disabled={isLocked || loading}
      >
