        ...
        <div className="flex justify-between h-24 items-center">
          ...
          >
            <div className="flex flex-col lg:flex-row w-full lg:space-x-2">
              ...
              <Link
                to="/"
                className={`px-4 py-2 transition-colors hover:bg-gray-100 ${isActive("/") ? "text-black bg-gray-300 rounded-sm" : "text-black"}`}
              ...
              <Link
                to="/about-us"
                title="About us"
                className={`px-4 py-2 transition-colors hover:bg-gray-100 ${isActive("/about-us") ? "text-black bg-gray-300 rounded-sm" : "text-black"}`}
                onClick={() => setIsOpen(false)}
              >
                About Us
              </Link>
              ...
              <button
                ...
                className="px-4 py-2 text-black hover:bg-gray-100 transition-colors text-left w-full lg:w-auto"
              >
                Our Services
              </button>
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className={`flex items-center px-4 py-2 transition-colors hover:bg-gray-100 w-full lg:w-auto ${isPartsActive ? "text-black bg-gray-300 rounded-sm" : "text-black"}`}
                >
                  Parts
                  <svg
                ...
                {isPartsOpen && (
                  <div className="absolute left-0 mt-2 bg-white border rounded-md shadow-lg z-30 min-w-[12rem] max-w-md p-2">
              ...
              <Link
                ...
                className={`px-4 py-2 transition-colors hover:bg-gray-100 ${isActive("/blog") ? "text-black bg-gray-300 rounded-sm" : "text-black"}`}
                onClick={() => setIsOpen(false)}
              >
                Blog
              </Link>
              ...
              <Link
                to="/contact"
                title="Contact us"
                className={`px-4 py-2 transition-colors hover:bg-gray-100 ${isActive("/contact") ? "text-black bg-gray-300 rounded-sm" : "text-black"}`}
                onClick={() => setIsOpen(false)}
              >
                Contact Us
              </Link>
