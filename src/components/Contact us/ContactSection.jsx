  ...
  const handleSubmit = async (e) => {
    ...
    const result = await Swal.fire({
      ...
      customClass: {
        ...
        confirmButton:
          "text-gray-700 bg-yellow-400 px-4 py-2 rounded font-semibold hover:bg-yellow-500",
        cancelButton:
          "text-white bg-red-500 px-4 py-2 rounded font-semibold hover:bg-red-600 ml-2",
      },
    ...
    try {
      ...
      const res = await fetch(
        "https://karmasila.com.np/karmashila/newsletter/subscribe_newsletter.php",
        {
          method: "POST",
      ...
      if (data.success) {
        ...
        await Swal.fire({
          ...
          customClass: {
            ...
            confirmButton:
              "bg-green-500 text-white px-4 py-2 rounded font-medium hover:bg-green-600",
          },
          // buttonsStyling: false
        });
      } else {
